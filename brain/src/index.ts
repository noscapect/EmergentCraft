...
createBrainServer(provider, new MemoryStore(resolve(process.env.EC_MEMORY_DIR ?? "data"))).listen(cfg.port, cfg.host, () => console.log(`[EmergentCraft Brain] listening on http://${cfg.host}:${cfg.port} (${cfg.provider})`));
