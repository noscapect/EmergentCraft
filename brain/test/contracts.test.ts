...
test("speech cannot accompany a non-speech candidate", () => assert.throws(() => validateDecision({ actionId:"wait:0",intent:"",goal:null,reflection:null,speech:"hello" }, perception)));
