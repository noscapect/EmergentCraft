...
class ActionValidationTest {
    ...
    @Test void attack_rejects_missing_lost_or_out_of_range_targets() { assertFalse(ActionValidation.canAttack(1,false,true)); assertFalse(ActionValidation.canAttack(1,true,false)); assertFalse(ActionValidation.canAttack(10,true,true)); assertTrue(ActionValidation.canAttack(9,true,true)); }
    @Test void placement_needs_an_offered_reachable_physical_target() { assertTrue(ActionValidation.canPlace(true,true,true,true,9)); assertFalse(ActionValidation.canPlace(true,false,true,true,9)); assertFalse(ActionValidation.canPlace(true,true,false,true,9)); }
